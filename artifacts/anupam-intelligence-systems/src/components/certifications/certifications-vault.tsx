...
function CertificationModal({
  ...
  const modal = (
    ...
    >
      ...
      <div className="relative z-10 flex h-[92vh] w-full max-w-6xl flex-col overflow-hidden rounded-2xl border border-white/12 bg-[#0c0f1a] shadow-[0_32px_80px_-8px_rgba(0,0,0,0.8)]">
        <div className="flex shrink-0 items-center gap-3 border-b border-white/8 bg-white/[0.03] px-4 py-3">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close certificate viewer"
            className="rounded-lg p-1.5 text-white/45 transition hover:bg-white/10 hover:text-white focus:outline-none focus:ring-2 focus:ring-primary/60"
            type="button"
          >
            <X className="h-4 w-4" />
          </button>
        ...
        <div className="grid min-h-0 flex-1 md:grid-cols-[320px_1fr]">
          <aside className="flex flex-col gap-5 border-b border-white/8 bg-white/[0.025] p-5 md:border-b-0 md:border-r">
            <div>
            ...
            <div className="mt-auto flex flex-col gap-2">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-xs font-bold uppercase transition hover:brightness-125 focus:outline-none focus:ring-2 focus:ring-primary/60"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3 font-mono text-xs text-white/70 transition hover:border-white/20 hover:text-white focus:outline-none focus:ring-2 focus:ring-primary/60"
              >
          ...
          <div className="min-h-0 bg-[#111827] p-3">
            <div className="flex h-full min-h-[420px] items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-white p-4">
              <img
                key={cert.thumb}
                src={cert.thumb}
        ...
        <div className="flex shrink-0 items-center justify-between gap-3 border-t border-white/8 bg-white/[0.02] px-5 py-3">
          <div className="flex items-center gap-1">
            <button
              onClick={onPrev}
              disabled={idx === 0}
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 text-white/50 transition hover:border-white/25 hover:text-white disabled:cursor-not-allowed disabled:opacity-20 focus:outline-none focus:ring-2 focus:ring-primary/60"
              type="button"
              aria-label="Previous certificate"
            >
              <ChevronLeft className="h-4 w-4" />
            </button>
            <span className="px-2 font-mono text-[10px] text-white/30">{idx + 1} of {total}</span>
            <button
              onClick={onNext}
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 rounded-lg border px-4 py-2 font-mono text-xs font-semibold transition hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-primary/60"
      ...
      <FadeContainer>
        <div className="glass flex flex-wrap items-center justify-between gap-6 rounded-2xl border border-primary/10 p-6">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="https://www.credly.com/users/anupam_roy/" target="_blank" rel="noreferrer" className="font-mono text-xs text-primary transition hover:text-white">
              Credly Profile
            </a>
            <a href="https://www.linkedin.com/in/anupam--roy/" target="_blank" rel="noreferrer" className="font-mono text-xs text-accent transition hover:text-white">
              LinkedIn
            </a>
          </div>
        </div>
