...
export default function SystemTimeDock({ onReplay }: SystemTimeDockProps) {
  ...
  return (
    <aside
      className="fixed bottom-3 left-3 z-[90] flex max-w-[calc(100vw-5.75rem)] items-center gap-1.5 border border-white/10 bg-[#07110f]/94 p-1.5 shadow-[0_8px_36px_rgba(0,0,0,0.38)] backdrop-blur-xl sm:bottom-8 sm:left-8 sm:max-w-none sm:gap-3 sm:p-2"
    ...
    >
      <div className="flex min-h-10 min-w-0 items-center gap-2 px-1.5 sm:px-2" aria-live="off">
        ...
        <div className="min-w-0">
          ...
          <span className="flex items-center gap-1 font-mono text-[8px] uppercase text-white/42 sm:hidden">
      ...
      <button
        type="button"
        onClick={onReplay}
        className="flex h-11 w-11 shrink-0 items-center justify-center border border-white/10 text-white/55 transition hover:border-primary/35 hover:bg-primary/8 hover:text-primary sm:w-auto sm:gap-2 sm:px-3"
